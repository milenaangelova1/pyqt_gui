...
from PyQt5.QtWidgets import QApplication, QMainWindow, QAction, QTableWidget, QInputDialog, QTableWidgetItem, QMenu
...
class Spreadsheet(QMainWindow):
    ...
    def addColumnBefore(self):
        current_column = self.table_widget.currentRow()
        self.table_widget.insertColumn(current_column)

    def addColumnAfter(self):
        current_column = self.table_widget.currentRow()
        self.table_widget.insertColumn(current_column + 1)
    ...
    def createTable(self):
        ...
        # set initial row and columns values
