...
from PyQt5.QtWidgets import QApplication, QTextEdit, QAction, QMainWindow, QFileDialog, QMessageBox, \
...
class Notepad(QMainWindow):
    ...
    def openFile(self):
        """
        Open a text or html file and display its contents in the
        text edit field.
        """
        ...
        if file_name:
            with open(file_name, "r") as f:
                self.text_field.setText(f.read())
        else:
            QMessageBox.information(self, "Error", "Unable to open file.", QMessageBox.Ok)

    def saveToFile(self):
        """
        If the save button is clicked, display dialog asking her if they want
        save the text in the text edit field to a text file.
        """
        ...
        if file_name.endswith('.txt'):
            ...
            with open(file_name, "w") as f:
                f.write(self.text_field.toHtml())
        else:
    ...
    def aboutDialog(self):
        ...
        """
        QMessageBox.about(self, "About Notepad","Rich Notepad")
