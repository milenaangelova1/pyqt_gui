...
from PyQt5.QtWidgets import QWidget, QApplication, QMainWindow, QAction, QStatusBar, QToolBar, QDockWidget, QPushButton, \
    QVBoxLayout, QLabel, QSizePolicy, QFileDialog, QMessageBox, QDesktopWidget
...
class PhotoEditor(QMainWindow):
    ...
    def createMenu(self):
        ...
        view_menu.addAction(self.toogle_dock_tools_act)
    ...
    def createToolsDockWidget(self):
        ...
        self.toogle_dock_tools_act = self.dock_tools_view.toggleViewAction()
    ...
    def clearImage(self):
        ...
        self.image = QPixmap() # isNull = True
